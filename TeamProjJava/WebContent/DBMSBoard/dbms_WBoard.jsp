      	...
      	<table class="table table-striped" style="text-align: center; ">
			...
			<tbody style="border: none; background-color:#DAAB8C;" >
					...
					<tr>
						...
						<textarea class="farm-control" placeholder="  글 내용" name="content" maxlength="2048" style="width:100%;height: 350px;border-radius: 5px;" readonly="readonly"><%data.getContent(); %></textarea>
						</td>
					</tr>
				</tbody>				
		</table>
				<a class="btn btn-primary pull-right" herf="" style="border-radius: 12px; border: none; background-color: #AC5E50; font-family:GyeonggiBatangOTF">수정</a>
				<a class="btn btn-primary pull-right" herf="" style="border-radius: 12px; border: none; background-color: #AC5E50; font-family:GyeonggiBatangOTF">삭제</a>
