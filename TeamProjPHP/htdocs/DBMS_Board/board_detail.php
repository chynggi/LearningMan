...
?>
    ...
    <br>
    &nbsp;&nbsp;
		<a style="border-radius: 12px; border: none; background-color: #382825; font-size: 15px; font-family: GyeonggiBatangOTF" class="btn btn-primary" href='./DBMSBoard_Update.php?board_no=<?=$Rows["NO"]?>'>수정</a>
		<a style="border-radius: 12px; border: none; background-color: #382825; font-size: 15px; font-family: GyeonggiBatangOTF" class="btn btn-danger" href='./DBMSBoard_Delete.php?board_no=<?=$Rows["NO"]?>'>삭제</a>
